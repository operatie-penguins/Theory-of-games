...
//------------------------------------------------------------------------------
  ...
  drawpanel.setBounds(15,42,660,330);
    ...
    rbvar1.setText("Игрок А продолжает игру");
    ...
    rbvar2.setText("Игрок В продолжает игру");
    ...
    rbvar3.setText("Бросается жребий. Ходит выигравший");
...
if(st>=0 && st<=400){
 ...
 if(st>=0 && st<=14){
   if(st==0){
     ...
     g.drawString("                             Упражнение по", 15, 160);
     g.drawString("                           позиционной игре", 15, 190);
 ...
 if(st>=1){
     if(st==1){
       ...
       txtArea.setText("Первым ход делает игрок  А.  Выберите стратегию.");
         if(fl==0){
           button2.setEnabled(false);
           rbtn3.setSelected(true);
         }
    ...
    // g.drawString("А", 547, 418 - 45-120);

     g.drawString("В", 577-230+30, 368 - 45-100-55+10);
     g.drawString("В", 517-230-30, 368 - 45-100-55+10);
     ...
     g.drawOval(310-12, 255, 50, 50);
     g.drawString("А", 547-230, 418 - 45-100+10);
     if(fl==1){
       g.drawLine(306, 261, 276, 198);
     }
     if(fl==2){
   ...
   if(st>=2){
     ...
     txtArea.setText("Какого максимального выигрыша может добиться игрок А, выбрав данную стратегию?");
     g.setColor(new Color(0, 0, 0));
   ...
   if(st>=3){
     ...
     txtArea.setText("Выбор какой стратегии (y = 1  или  y = 2) в данной ситуации приведет игрока  В  к наименьшим");
     txtArea_1.setText("потерям?");
   ...
   if(st>=4){
     ...
     txtArea.setText("Что должно произойти дальше?");
     if(fl==2 && fl1==1){
         g.setColor(Color.LIGHT_GRAY);
         g.fillOval(366-17, 146-4, 68, 68);
         g.setColor(Color.white);
   ...
   if(st>=5){
     ...
     txtArea.setText("Ход игрока В выберите стратегию.");
   ...
   if(st>=6){
     ...
     txtArea.setText("Введите недостающие числа в функцию выигрыша W (x, y).");
     g.setColor(new Color(0, 0, 0));
     fl2=0;
   }
   if(st>=7){
     if(st==7){
       ...
       g.drawString("В   - [1, 1]   (' y = 1    при любом выборе x ')",85,175);
       g.drawString("В   - [1, 2]   (' y = x    при любом выборе x ')",85,185);
       g.drawString("В   - [2, 1]   (' y # x    при любом выборе x ')",85,195);
       g.drawString("В   - [2, 2]   (' y = 2    при любом выборе x ')",85,205);
   ...
   if(st>=8){
     if(st==8)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("то в этих случаях выигрыш игрока  А  равен  -1.",130,220+60-120);
     //Stringer.drawString("равен  -1.",15,240+60);
     g.setColor(Color.LIGHT_GRAY);
   ...
   if(st>=9){
     if(st==9)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("Теперь рассмотрим случай,  когда игрок  А  выбирает стратегию",35,260+40-120);
     Stringer.drawString("А_{2}  -  'выбрать x = 2'.",15,280+40-120);
   ...
   if(st>=10){
     if (st == 10)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("Ход игрока В.", 35, 280 + 60-120);
     g.setColor(new Color(200, 0, 0));
     g.drawOval(570, 350 - 45-120, 25, 25);
     g.drawString("В", 577, 368 - 45-120);
     g.setColor(new Color(0, 0, 0));
   ...
   //g.fillRect(523,325-230+15-4+240,60,34);
     ...
     //g.drawString("А", 547, 418 - 45);

     //g.drawString("В", 577, 368 - 45);
     g.drawString("В", 517, 368 - 45-120);
   ...
   if (st >= 11) {
     if (st == 11){
       g.setColor(new Color(0, 0, 120));
       g.setFont(Stringer.font_lab);
       g.drawString("В   - [1, 1]   (' y = 1    при любом выборе x ')",85,275);
       g.drawString("В   - [1, 2]   (' y = x    при любом выборе x ')",85,285);
       g.drawString("В   - [2, 1]   (' y # x    при любом выборе x ')",85,295);
       g.drawString("В   - [2, 2]   (' y = 2    при любом выборе x ')",85,305);
       g.setFont(new Font("Arial",1,7));
     ...
     Stringer.drawString("Точно так же, допустим, из четырех своих стратегий игрок  В", 35, 280 + 80-120);
     Stringer.drawString("выбирает стратегию  В_{1}  или  В_{3} (т.е.  y = 1).", 15,300 + 80-120);
     //Stringer.drawString("или  В_{3} (т.е.  y = 1).",15,320+80);
     g.setColor(new Color(200, 0, 0));
     g.drawLine(580, 351 - 45-120, 569, 320 - 45-120);
     g.drawString("1", 565, 344 - 45-120);
     g.setColor(new Color(0, 0, 0));
   ...
   if (st >= 12) {
     if (st == 12)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("В этих случаях выигрыш игрока  А  равен  -2.", 35,
                         320 + 80-120);
     g.setColor(Color.LIGHT_GRAY);
     g.drawLine(586, 351 - 45-120, 597, 320 - 45-120);
     g.drawOval(593, 310 - 45-120, 10, 10);
   ...
   if (st >= 13) {
     if (st == 13)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("Если   же  игрок   В   выберет  стратегию   В_{2}   или   В_{4}   (т.е.  y = 2),",
                         35, 340 + 80-120);
     g.setColor(new Color(0, 0, 0));
     g.drawLine(586, 351 - 45-120, 597, 320 - 45-120);
     g.drawOval(593, 310 - 45-120, 10, 10);
   ...
   if (st >= 14) {
     if (st == 14)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("то  в  таких  случаях", 480, 360 + 60-120);
     Stringer.drawString("выигрыш игрока  А  равен  2.", 15, 360 + 80-120);
     g.setColor(Color.LIGHT_GRAY);
     g.drawOval(563, 310 - 45-120, 10, 10);
     g.drawString("-2", 560, 304 - 45-120);
     g.drawLine(580, 351 - 45-120, 569, 320 - 45-120);
 ...
 if(st>=15 && st<=30){
   if(st>=15){
     if(st==15)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("Таблица выигрышей и матрица игры выглядят так:", 35, 20);
     g.setColor(new Color(0, 0, 0));
     ...
     Stringer.drawString("А_{1}", 14 , 414-170+160-300);
     Stringer.drawString("А_{2}", 14, 434-170+160-300);
     ...
     Stringer.drawString("В_{1}", 85 , 374-170+160-300);
     Stringer.drawString("В_{2}", 135 , 374-170+160-300);
     Stringer.drawString("В_{3}", 185 , 374-170+160-300);
     Stringer.drawString("В_{4}", 235 , 374-170+160-300);
   ...
   if (st >= 16) {
     if (st == 16)
       g.setColor(new Color(0, 0, 120));
     g.drawString("Полученная матрица имеет седловую точку.", 35, 140+30);
     g.setColor(new Color(200, 0, 0));
   ...
   if (st >= 17) {
     if (st == 17)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("Оптимальные  стратегии  игроков:  A_{1} - (1)  и  В_{3} - [2, 1].",35, 160+120);
     Stringer.drawString("Тем   самым,   игрок   А   на   1-м   ходе   выбирает   x = 1,",15, 180+120);
     Stringer.drawString("а  игрок  В  на  2-м  ходе  выбирает  y = 2.  Цена  игры  v = -1.",15, 200+120);
     ...
     g.drawString("А", 547, 418 - 45 - 220-20+60+100);

     g.drawString("В", 577, 368 - 45 - 220-20+60+100);
     g.drawString("В", 517, 368 - 45 - 220-20+60+100);
 ...
 if(st>=42 && st<=54){
   if (st >= 42) {
     ...
     g.drawString("Пример 2:", 15, 20);
     g.setFont(new Font("Times New Roman", 1, 14));

     g.drawString("Условия  те  же,  что  и  в  предыдущем  примере,  кроме  одного  -  игрок  В  не  знает",
                  90, 20);
     g.drawString("стратегию, выбранную игроком А на 1-м ходе.", 15, 40);
     //Stringer.drawString("А_{1} - 'выбрать x = 1',                  А_{2} - 'выбрать x = 2'.",95,190);
     ...
     g.drawString("А", 547, 418 - 100 + 55 - 180);

     g.drawString("В", 577, 368 - 100 + 55 - 180);
     g.drawString("В", 517, 368 - 100 + 55 - 180);
   ...
   if (st >= 43) {
     ...
     g.drawString("Пример 2:", 15, 20);
     g.setFont(new Font("Times New Roman", 1, 14));
     g.drawString("Стратегии игрока А остаются те же:", 35, 60);
     Stringer.drawString(
         "А_{1} - 'выбрать x = 1',                  А_{2} - 'выбрать x = 2'.",
         95, 90);
   }
   if (st >= 44) {
     if (st == 44)
     ...
     g.setFont(new Font("Times New Roman", 1, 14));
     g.drawString(
         "Так как игроку В выбор игрока А неизвестен, то есть игрок В", 35,
         120);
     g.drawString(
         "не знает, в какой именно из 2-х позиций он находится (см.рис.),",
         15, 140);
     g.drawString("то у него те же две стратегии:", 15, 200);
     Stringer.drawString(
         "В_{1} - 'выбрать y = 1',                  В_{2} - 'выбрать y = 2'.",
         95, 170);
   }
   ...
   if (st >= 45) {
     ...
     g.drawString("Рассмотрим возможные варианты игры.", 35, 220);
   }
   if (st >= 46) {
     if (st == 46)
       g.setColor(new Color(0, 0, 120));
     ...
     g.drawString("Начинает игрок А.", 35, 240);
     g.setColor(Color.LIGHT_GRAY);
     ...
     g.drawString("А", 547, 418 - 45 - 180);

     g.drawString("В", 577, 368 - 45 - 180);
     g.drawString("В", 517, 368 - 45 - 180);
   ...
   if (st >= 47) {
     ...
     Stringer.drawString(
         "Из  двух  возможных  стратегий  он  выбирает  А_{1}  -  'выбрать x = 1'.",
         35, 260);
     g.setColor(new Color(200, 0, 0));
     g.drawLine(545, 403 - 45 - 180, 530, 373 - 45 - 180);
     g.drawString("1", 529, 397 - 45 - 180);
   ...
   if (st >= 48) {
     ...
     Stringer.drawString("Ход игрока В. (Так  как  он  не  знает  предыдущего  хода, то  информационное  множество",
                         35, 280);
     Stringer.drawString("выглядит так.)", 15, 300);
     //Stringer.drawString("игрока В.",15,180);
     g.setColor(Color.white);
     //g.fillOval(536, 396 - 45, 34, 34);
     //g.fillOval(566, 346 - 45, 34, 34);
   ...
   if (st >= 49) {
     ...
     Stringer.drawString(
         "Допустим, из двух своих стратегий он выбирает стратегию  В_{1} (т.е.  y = 1).",
         35, 320);
     g.setColor(new Color(200, 0, 0));
     g.drawLine(520, 351 - 45 - 180, 509, 320 - 45 - 180);
     g.drawString("1", 505, 344 - 45 - 180);
     ...
     if (st >= 50) {
       if (st == 50)
         g.setColor(new Color(0, 0, 120));
       Stringer.drawString("В этом случае выигрыш игрока  А  равен  1.",
                           15 + 20, 340);
     ...
     if (st >= 51) {
       if (st == 51)
         g.setColor(new Color(0, 0, 120));
       Stringer.drawString("Если  же  игрок  В  на  своем  ходе  выберет  стратегию  В_{2}  (то  есть  y = 2),",
                           35, 360);
       g.setColor(new Color(0, 0, 0));
       g.drawOval(533, 310 - 45 - 180, 10, 10);
       g.drawString("-1", 531, 304 - 45 - 180);
     ...
     if (st >= 52) {
       if (st == 52)
         g.setColor(new Color(0, 0, 120));
       Stringer.drawString("то в этом случае ", 530, 360);
       Stringer.drawString("выигрыш игрока  А  равен  -1.", 15, 380);
     ...
     if (st >= 53) {
       if (st == 53)
         g.setColor(new Color(0, 0, 120));
       Stringer.drawString(
           "Теперь рассмотрим случай,  когда игрок  А  выбирает стратегию",
           35, 400);
       Stringer.drawString("А_{2}  -  'выбрать x = 2'.", 15, 420);
     ...
     if (st >= 54) {
       if (st == 54)
         g.setColor(new Color(0, 0, 120));
       Stringer.drawString("Ход игрока В.", 35, 440);
       g.setColor(new Color(200, 0, 0));
       g.drawOval(570, 350 - 45 - 180, 25, 25);
       g.drawString("В", 577, 368 - 45 - 180);
       g.setColor(new Color(0, 0, 0));
 ...
 if (st >= 55) {
     if (st == 55)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString(
         "Точно так же, допустим, из двух своих стратегий игрок  В  выбирает стратегию  В_{1} (т.е.  y = 1).", 35,
         20);
     //Stringer.drawString("выбирает стратегию  В_{1} (т.е.  y = 1).", 15,160);
     //Stringer.drawString("или  В_{3} (т.е.  y = 1).",15,320+80);
     g.setColor(Color.LIGHT_GRAY);
       g.fillOval(536, 396 - 45 - 180, 34, 34);
       g.fillOval(566, 346 - 45 - 180, 34, 34);
   ...
   if (st >= 56) {
     if (st == 56)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("В этом случае выигрыш игрока  А  равен  -2.", 35,
                         40);
     g.setColor(Color.white);
     g.drawLine(526, 351 - 45-180, 537, 320 - 45-180);
     g.drawLine(520, 351 - 45-180, 509, 320 - 45-180);
   ...
   if (st >= 57) {
     if (st == 57)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("Если   же  игрок   В   выберет  стратегию   В_{2}  (т.е.  y = 2),",
                         35, 60);
     g.setColor(new Color(0, 0, 0));
   ...
   if (st >= 58) {
     if (st == 58)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("то  в  этом  случае  выигрыш ", 420, 60);
     Stringer.drawString("игрока  А  равен  2.", 15, 80);
     g.setColor(Color.LIGHT_GRAY);
     g.drawString("-1", 531, 304 - 45-180);
     g.drawString("1", 505, 304 - 45-180);
     g.drawString("1", 505, 344 - 45-180);
   ...
   if (st >= 59) {
     if (st == 59)
       g.setColor(new Color(0, 0, 120));
     g.drawString(
         "Соответствующая таблица выигрышей игрока А имеет вид:",
         35, 100);
     g.setColor(Color.LIGHT_GRAY);
     g.fillOval(536, 396 - 45-180, 34, 34);
     g.fillOval(566, 346 - 45-180, 34, 34);
     ...
     Stringer.drawString("А_{1}", 14 + 120, 414-125-100);
     Stringer.drawString("А_{2}", 14 + 120, 434-125-100);
     ...
     Stringer.drawString("В_{1}", 85 + 120, 374-125-100);
     Stringer.drawString("В_{2}", 135 + 120, 374-125-100);
   ...
   if(st>=60){
     if(st==60)
       g.setColor(new Color(0, 0, 120));
     g.setFont(new Font("Times New Roman", 1, 14));
     g.drawString("Соответствующая матрица игры имеет вид:",35, 260);
     //////матрица
     g.setColor(new Color(0, 0, 0));
   ...
   if (st >= 61) {
       if (st == 61)
         g.setColor(new Color(0, 0, 120));
       g.drawString("Полученная матрица седловой точки не имеет. Оптимальные смешанные стратегии игроков:",
                    35, 380);
       g.drawString("                                                   P = { -,  - }  и  Q = { -, - }.",15+30, 410);
       g.drawString("Цена  игры  v = 0.",
                    35, 440);
 ...
 if (st >= 510 && st <= 570) {
   if (st >= 51) {
     if (st == 51)
       g.setColor(new Color(0, 0, 120));
     g.setFont(new Font("Times New Roman", 1, 14));
     g.drawString("Приведённые  выше  примеры  не  исчерпывают  всех  возможных  вариантов  даже  в  этом,", 35, 20);
     g.drawString("самом простом, случае двухходовых позиционных игр. ", 15, 40);
   }
       ...
       if (st == 52)
         g.setColor(new Color(0, 0, 120));
       g.setFont(new Font("Times New Roman", 1, 14));
       g.drawString("Рассмотрим  теперь  несколько  примеров  сведения  к  матричным  играм  позиционных  игр,",
                    35, 60);
       g.drawString("состоящих  из  трех  ходов,  сосредоточив  при  этом  основное  внимание  на  одном  из  наиболее",
                    15, 80);
       g.drawString(
           "ответственных шагов нормализации - описании стратегий игроков.",
           15, 100);
     }
     if (st >= 53) {
       if (st == 53)
         g.setColor(new Color(0, 0, 120));
       g.setFont(new Font("Times New Roman", 3, 15));
       g.drawString("Пример 3:", 15, 120);
       g.setFont(new Font("Times New Roman", 1, 14));
       g.drawString("1-й ход делает игрок А:  он  выбирает  число  x", 90,
                    120);
       g.drawString("из  множества  двух  чисел  {1, 2}.", 15, 140);
     ...
     if (st >= 54) {
       ...
       g.drawString("Пример 3:", 15, 120);
       g.setFont(new Font("Times New Roman", 1, 14));
       g.drawString("2-й ход делает игрок В: зная выбранное игроком А", 15,
                    160);
       g.drawString("число x, он выбирает число  y  из множества двух", 15,
                    180);
       g.drawString("чисел {1, 2}.", 15, 200);
     ...
     if (st >= 55) {
       ...
       g.drawString("Пример 3:", 15, 120);
       g.setFont(new Font("Times New Roman", 1, 14));
       g.drawString("3-й  ход  делает  игрок  А:  не  зная  о  выбранном",
                    15, 220);
       g.drawString("игроком В числе  y  на 2-м ходе  и  забыв выбранное",
                    15, 240);
       g.drawString("им самим на 1-м ходе число x, он выбирает число  z",
                    15, 260);
       g.drawString("из множества двух числе {1, 2}.", 15, 280);
     ...
     if (st >= 56) {
       ...
       g.setFont(new Font("Times New Roman", 1, 14));
       g.drawString(
           "После этого игрок А получает вознаграждение W(x, y, z)", 15,
           300);
       g.drawString("за счет игрока В, например такое:", 15, 320);
       g.drawString(
           "             W(1, 1, 1) = -2,              W(2, 1, 1) =  3",
           15, 350);
       g.drawString(
     ...
     if (st >= 57) {
       ...
       g.setFont(new Font("Times New Roman", 1, 14));
       g.drawString(
           "На рисунке показаны дерево игры и информационные множества.",
           35, 440);
   ...
   if (st >= 580 && st <= 630) {
     if (st >= 58) {
       if (st == 58)
         g.setColor(new Color(0, 0, 120));
       g.drawString("Нормализуем эту игру.", 35, 20);
     }
     if (st >= 59) {
       if (st == 59)
         g.setColor(new Color(0, 0, 120));
       g.drawString("Поскольку игроку  В  выбор игрока  А  на 1-м ходе  известен,  то  у  игрока  В  -  4  стратегии:",
                    35, 40);
       Stringer.drawString(
     ...
     if (st >= 60) {
       if (st == 60)
         g.setColor(new Color(0, 0, 120));
       g.drawString("Игрок  А  на 3-м ходе не знает предыдущих выборов - ни значения  x, ни значения  y. Поэтому",
                    35, 80);
       g.drawString("каждая  его  стратегия  состоит  просто  из  пары  чисел  (x, z),  где  x (x = 1, 2)  -  альтернатива,",
                    15, 100);
       g.drawString("выбираемая игроком  А  на  1-м  ходе, а  z (z = 1, 2) - альтернатива, выбираемая игроком  А  на",
                    15, 120);
       g.drawString("3-м ходе.", 15, 140);
     }
     if (st >= 61) {
       if (st == 61)
         g.setColor(new Color(0, 0, 120));
       g.drawString("Например, выбор игроком  А  стратегии (2, 1) означает, что на  1-м  ходе  он  выбирает x = 2,",
                    35, 160);
       g.drawString("а на  3-м  ходе  -  z = 1.", 15, 180);
       g.drawString("Таким образом у игрока  А  четыре стратегии:", 165,
                    180);
       Stringer.drawString(
           "А_{1} - (1, 1),    А_{2} - (1, 2),    А_{3} - (2, 1),    А_{4} - (2, 2).",
           180, 200);
     }
     ...
     if (st >= 62) {
       if (st == 62)
         g.setColor(new Color(0, 0, 120));
       Stringer.drawString("Пусть, например, игрок  А  выбрал стратегию A_{2}  -  (1, 2), а игрок  В  -  стратегию  В_{3}  -  [2, 1].",
                           35, 220);
       g.drawString("Тогда  x = 1,  откуда вытекает, что  y = 2.  Значение  z = 2  выбрано игроком  А  независимо  от",
                    15, 240);
       g.drawString("выбора игрока  В.  Вычисляя значение функции выигрышей для этого набора, получаем:",
                    15, 260);
     ...
     if (st >= 63) {
       if (st == 63)
         g.setColor(new Color(0, 0, 120));
       g.drawString("Получив остальные 15 выигрышей, строим таблицу выигрышей игрока  А  и матрицу игры.",
                    35, 300);
       g.setColor(new Color(0, 0, 0));
       ...
       Stringer.drawString("А_{1}", 14, 374);
       Stringer.drawString("А_{2}", 14, 394);
       Stringer.drawString("А_{3}", 14, 414);
       Stringer.drawString("А_{4}", 14, 434);
       ...
       Stringer.drawString("В_{1}", 90, 334);
       Stringer.drawString("В_{2}", 150, 334);
       Stringer.drawString("В_{3}", 210, 334);
       Stringer.drawString("В_{4}", 270, 334);
...
if(st>13){
  if (pr==0)
  Stringer.drawString("F = P_{i} (u_{i}) множество осторожных стратегий.",10,155-3);
  if (pr==1)
    ...
    if(st==2){
      if (fl == 1)
        if (jTextField1.getText().equals("1"))
          lbl_prov.setText("Правильно");
        else
          lbl_prov.setText("Неправильно");
  ...
  void txtF2_keyPressed(KeyEvent e) {
    ...
    /* class  Panel_paint4 extends JPanel {
         public void paintComponent(Graphics g) {
           ...
           //if(st>=2)
             g.drawString("На рисунке показаны дерево игры и информационное множество.",10,105);
         }}
