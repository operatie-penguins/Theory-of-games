...
if(st>=0 && st<=400){
 ...
 if(st>=0 && st<=14){
   if(st==0){
     ...
     g.drawString("                         Пример нормализации", 15, 170);
 ...
 if(st>=1){
     ...
     g.drawString("Рассмотрим возможные варианты игры.",35,140-120);
   }
   if(st>=2){
     if(st==2)
       g.setColor(new Color(0, 0, 120));
   ...
   if(st>=3){
     if(st==3)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("Из  двух  возможных  стратегий  он  выбирает  А_{1}  -  'выбрать x = 1'.",160-125,160+20-120);
     g.setColor(new Color(200, 0, 0));
     g.drawLine(545, 403 - 45-120, 530, 373 - 45-120);
     g.drawString("1", 529, 397 - 45-120);
     g.setColor(new Color(0, 0, 0));
   ...
   if(st>=4){
     if(st==4)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("Ход игрока В.",610-575,160+40-120);
   ...
   if(st>=5){
     if(st==5){
       ...
       g.drawString("В   - [1, 1]   (' y = 1    при любом выборе x ')",85,115);
       g.drawString("В   - [1, 2]   (' y = x    при любом выборе x ')",85,125);
       g.drawString("В   - [2, 1]   (' y # x    при любом выборе x ')",85,135);
       g.drawString("В   - [2, 2]   (' y = 2    при любом выборе x ')",85,145);
       g.setFont(new Font("Arial",1,7));
       g.drawString("1",92,118);
       g.drawString("2",92,128);
       g.drawString("3",92,138);
       g.drawString("4",92,148);
       g.setFont(new Font("Times New Roman",1,14));
     }
     Stringer.drawString("Допустим, из четырех своих стратегий он выбирает стратегию  В_{1}  или  В_{2} (т.е.  y = 1).",80-45,180+40-120);
     g.setColor(new Color(200, 0, 0));
     g.drawLine(520, 351 - 45-120, 509, 320 - 45-120);
     g.drawString("1", 505, 344 - 45-120);
     g.setColor(new Color(0, 0, 0));
   ...
   if(st>=6){
     if(st==6)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("В этих случаях выигрыш игрока  А  равен  1.",15+20,200+40-120);
     g.setColor(Color.LIGHT_GRAY);
     g.drawLine(526, 351 - 45-120, 537, 320 - 45-120);
     g.drawOval(533, 310 - 45-120, 10, 10);
     g.drawString("2", 536, 344 - 45-120);
   ...
   if(st>=7){
     ...
     Stringer.drawString("Если же игрок В на своем ходе выберет стратегию В_{3} или",35,220+40-120);
     Stringer.drawString("В_{4} (то есть y = 2),",15,240+40-120);
     g.setColor(new Color(0, 0, 0));
     g.drawOval(533, 310 - 45-120, 10, 10);
     g.drawString("-1", 531, 304 - 45-120);
     g.drawOval(503, 310 - 45-120, 10, 10);
