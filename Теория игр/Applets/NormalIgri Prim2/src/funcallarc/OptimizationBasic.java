...
public static Color color_title=new Color(180, 0, 60);
public static Color color_text=new Color(0, 0, 80);
public static Color color_ramka=new Color(157, 187, 255);
public static Color color_rbn=new Color(0,0,145);
public static Color color_help=new Color(0,0,150);
public static Font font_main=new Font("Dialog", 1, 14);
public static Font font_help=new Font("Dialog", 1, 12);
public static Font font13=new Font("Dialog", 1, 10);
public static Font font12=new Font("Dialog", 1, 11);
public static Font font14=new Font("Dialog", 1, 9);
public static Font font_Kontr_title=new Font("Dialog", 1, 24);
public static Font font_theme_title=new Font("Dialog", 1, 22);
public static Font font_metod_title=new Font("Dialog", 1, 26);
public static Font font_question=new Font("Dialog", 3, 14);
public static Font font_title=new Font("Dialog", 3, 12);
public static Font font_mark=new Font("Dialog", 1, 16);
public static Font font_result=new Font("Dialog", 3, 13);
