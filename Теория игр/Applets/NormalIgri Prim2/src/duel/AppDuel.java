...
if(st>=0 && st<=400){
 ...
 if(st>=9 && st<=17){
     ...
     if (st >= 11) {
       if (st == 11)
         g.setColor(new Color(0, 0, 120));
       Stringer.drawString("то в этом случае ", 530, 360-320);
       Stringer.drawString("выигрыш игрока  А  равен  -1.", 15, 380-320);
     ...
     if (st >= 12) {
       ...
       Stringer.drawString(
           ...
           35, 400-320);
       Stringer.drawString("А_{2}  -  'выбрать x = 2'.", 15, 420-320);
     ...
     if (st >= 13) {
       if (st == 13)
         g.setColor(new Color(0, 0, 120));
       Stringer.drawString("Ход игрока В.", 35, 440-320);
       g.setColor(new Color(200, 0, 0));
       g.drawOval(570, 350 - 45 - 180, 25, 25);
       g.drawString("В", 577, 368 - 45 - 180);
       g.setColor(new Color(0, 0, 0));
   ...
   if (st >= 14) {
     if (st == 14)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("Точно так же, допустим, из двух своих стратегий игрок  В ",35,20+120);
   ...
   if (st >= 17) {
     if (st == 17)
       g.setColor(new Color(0, 0, 120));
     Stringer.drawString("то в этом", 415, 60+140);
     Stringer.drawString("случае  выигрыш  игрока  А  равен  2.", 15, 80+140);
     g.setColor(Color.LIGHT_GRAY);
     g.drawString("-1", 531, 304 - 45-180);
     g.drawString("1", 505, 304 - 45-180);
     g.drawString("1", 505, 344 - 45-180);
 ...
 if(st>=18 && st<=20){
   if (st >= 18) {
     if (st == 18)
       g.setColor(new Color(0, 0, 120));
     g.drawString("Соответствующая таблица выигрышей игрока А имеет вид:",35, 100-80);
     /*g.setColor(Color.LIGHT_GRAY);
     ...
     Stringer.drawString("А_{1}", 14 + 120+120, 414-125-100-100);
     Stringer.drawString("А_{2}", 14 + 120+120, 434-125-100-100);
     ...
     Stringer.drawString("В_{1}", 85 + 120+120, 374-125-100-100);
     Stringer.drawString("В_{2}", 135 + 120+120, 374-125-100-100);
   ...
   if(st>=19){
     if(st==19)
       g.setColor(new Color(0, 0, 120));
     g.setFont(new Font("Times New Roman", 1, 14));
     g.drawString("Соответствующая матрица игры имеет вид:",35, 260-100);
     //////матрица
     g.setColor(new Color(0, 0, 0));
   ...
   if (st >= 20) {
       if (st == 20)
         g.setColor(new Color(0, 0, 120));
       g.drawString("Полученная матрица седловой точки не имеет. Оптимальные смешанные стратегии игроков:",35, 380-120);
       g.drawString("                                                   P = { -,  - }  и  Q = { -, - }.",15+30, 410-120);
       g.drawString("Цена  игры  v = 0.", 35, 440-120);
  ...
  Stringer.drawString("F = P_{i} (u_{i}) set of cautious strategy.",10,155-3);
     ...
     class  Panel_paint4 extends JPanel {
         public void paintComponent(Graphics g) {
           ...
           g.drawString("2-й ход.   Игрок   В   выбирает число   y   из множества двух чисел  {1, 2},  не зная выбор  числа  x",10,30);
